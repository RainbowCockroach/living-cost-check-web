...
const messages = {
  vi: {
    ...
    "targets.kind.by_date": "Đến hạn theo ngày",
    "targets.kind.monthly_refill": "Đắp bù hàng tháng",
    "targets.kind.monthly_contribution": "Góp đều hàng tháng",
    "targets.monthsLeft": "{n} tháng còn lại",
    "targets.monthOverdue": "Đã quá hạn",
    "targets.deleteConfirm": "Xoá mục tiêu cho “{name}”?",
    ...
    "targets.loadFailed": "Không tải được danh sách mục tiêu.",
    "targets.saveFailed": "Lưu mục tiêu thất bại.",
    "targets.deleteFailed": "Xoá mục tiêu thất bại.",

    "budget.col.needed": "Cần",
    "budget.col.target": "Mục tiêu",
    "budget.assignNeeded": "Phân bổ {amount} ₫",
    "budget.addTarget": "+ Thêm mục tiêu",
  },
  en: {
    "nav.new": "New",
